...
ActiveRecord::Schema.define(version: 20180122232425) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.index ["ingredient_1_id"], name: "index_items_on_ingredient_1_id"
    t.index ["ingredient_2_id"], name: "index_items_on_ingredient_2_id"
  end
